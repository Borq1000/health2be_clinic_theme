                ...
                <div class="container">
                    <div class="header-property-detail">
                        ...
                        <div class="content-bottom">
                            ...
                            <ul class="icon-box">
                                <li><a href="property-details-v4.html#" class="item">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="image-sw-single">
                                            <img src="<?php bloginfo('template_url') ?>/images/banner/banner-property-12.jpg" alt="images">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="image-sw-single">
                                            <img src="<?php bloginfo('template_url') ?>/images/banner/banner-property-11.jpg" alt="images">
    
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="image-sw-single">
                                            <img src="<?php bloginfo('template_url') ?>/images/banner/banner-property-10.jpg" alt="images">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="image-sw-single">
                                            <img src="<?php bloginfo('template_url') ?>/images/banner/banner-property-13.jpg" alt="images">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="image-sw-single">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="<?php bloginfo('template_url') ?>/images/banner/thumb-sw1.jpg" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="<?php bloginfo('template_url') ?>/images/banner/thumb-sw2.jpg" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="<?php bloginfo('template_url') ?>/images/banner/thumb-sw3.jpg" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="<?php bloginfo('template_url') ?>/images/banner/thumb-sw4.jpg" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="<?php bloginfo('template_url') ?>/images/banner/thumb-sw5.jpg" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="<?php bloginfo('template_url') ?>/images/banner/thumb-sw6.jpg" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="<?php bloginfo('template_url') ?>/images/banner/thumb-sw7.jpg" alt="images">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-thumb-pagi">
                                        <img src="<?php bloginfo('template_url') ?>/images/banner/thumb-sw8.jpg" alt="images">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                            <div class="single-property-element single-property-desc">
                                ...
                                <a href="property-details-v4.html#" class="btn-view"><span class="text">View More</span> </a>
                            </div>
                            <div class="single-property-element single-property-overview">
                                <h6 class="title fw-6">Overview</h6>
                                <ul class="info-box">
                                    <li class="item">
                                        <a href="property-details-v4.html#" class="box-icon w-52"><i class="icon icon-house-line"></i></a>
                                        <div class="content">
                                    ...
                                    <li class="item">
                                        <a href="property-details-v4.html#" class="box-icon w-52"><i class="icon icon-sliders-horizontal"></i></a>
                                        <div class="content">
                                    ...
                                    <li class="item">
                                        <a href="property-details-v4.html#" class="box-icon w-52"><i class="icon icon-garage"></i></a>
                                        <div class="content">
                                    ...
                                    <li class="item">
                                        <a href="property-details-v4.html#" class="box-icon w-52"><i class="icon icon-bed1"></i></a>
                                        <div class="content">
                                    ...
                                    <li class="item">
                                        <a href="property-details-v4.html#" class="box-icon w-52"><i class="icon icon-bathtub"></i></a>
                                        <div class="content">
                                    ...
                                    <li class="item">
                                        <a href="property-details-v4.html#" class="box-icon w-52"><i class="icon icon-crop"></i></a>
                                        <div class="content">
                                    ...
                                    <li class="item">
                                        <a href="property-details-v4.html#" class="box-icon w-52"><i class="icon icon-hammer"></i></a>
                                        <div class="content">
                                    ...
                                    <li class="item">
                                        <a href="property-details-v4.html#" class="box-icon w-52"><i class="icon icon-ruler"></i></a>
                                        <div class="content">
                            ...
                            <div class="single-property-element single-property-video">
                                ...
                                <div class="img-video">
                                    <img src="<?php bloginfo('template_url') ?>/images/banner/img-video.jpg" alt="img-video">
                                ...
                                <ul class="box-floor" id="parent-floor">
                                    <li class="floor-item">
                                        ...
                                        <div id="floor-one" class="collapse show" data-bs-parent="#parent-floor">
                                            <div class="faq-body">
                                                <div class="box-img">
                                                    <img src="<?php bloginfo('template_url') ?>/images/banner/floor.png" alt="img-floor">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="single-property-element single-property-attachments">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="property-details-v4.html#" target="_blank" class="attachments-item">
                                            <div class="box-icon w-60">
                                                <img src="<?php bloginfo('template_url') ?>/images/home/file-1.png" alt="file">
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <a href="property-details-v4.html#" target="_blank" class="attachments-item">
                                            <div class="box-icon w-60">
                                                <img src="<?php bloginfo('template_url') ?>/images/home/file-2.png" alt="file">
                                            </div>
                                            <span>Villa-Document.pdf</span>
                                            <i class="icon icon-download"></i>
                                        </a>
                            ...
                            <div class="single-property-element single-property-explore">
                                ...
                                <div class="box-img">
                                    <img src="<?php bloginfo('template_url') ?>/images/banner/img-explore.jpg" alt="img">
                                    <div class="box-icon">
                            ...
                            <div class="single-property-element single-property-loan">
                                ...
                                <form action="property-details-v4.html#" class="box-loan-calc">
                                    <div class="box-top">
                                        <div class="item-calc">
                                    ...
                                    <ul class="box-review">
                                        <li class="list-review-item">
                                            <div class="avatar avt-60">
                                                <img src="<?php bloginfo('template_url') ?>/images/avatar/avt-2.jpg" alt="avatar">
                                            </div>
                                            <div class="content">
                                                <div class="box-head">
                                                ...
                                                <div class="box-img">
                                                    <div class="img">
                                                        <img src="<?php bloginfo('template_url') ?>/images/blog/review1.jpg" alt="review">
                                                    </div>
                                                    <div class="img">
                                                        <img src="<?php bloginfo('template_url') ?>/images/blog/review2.jpg" alt="review">
                                                    </div>
                                                    <div class="img">
                                                        <img src="<?php bloginfo('template_url') ?>/images/blog/review3.jpg" alt="review">
                                                    </div>
                                                </div>
                                        ...
                                        <li class="list-review-item">
                                            <div class="avatar avt-60">
                                                <img src="<?php bloginfo('template_url') ?>/images/avatar/avt-3.jpg" alt="avatar">
                                            </div>
                                            <div class="content">
                                                <div class="box-head">
                                                    <div class="d-flex align-items-center flex-wrap justify-content-between gap-8">
                                        ...
                                        <li class="list-review-item">
                                            <div class="avatar avt-60">
                                                <img src="<?php bloginfo('template_url') ?>/images/avatar/avt-4.jpg" alt="avatar">
                                            </div>
                                            <div class="content">
                                                <div class="box-head">
                                                    <div class="d-flex align-items-center flex-wrap justify-content-between gap-8">
                                ...
                                <div class="widget-box single-property-contact">
                                    ...
                                    <div class="box-avatar">
                                        <div class="avatar avt-100 round">
                                            <img src="<?php bloginfo('template_url') ?>/images/avatar/avt-lg-single.jpg" alt="avatar">
                                        </div>
                                        <div class="info">
                                    ...
                                    <form action="property-details-v4.html#" class="contact-form">
                                        <div class="ip-group">
                                ...
                                <div class="flat-tab flat-tab-form widget-filter-search widget-box">
                                    <ul class="nav-tab-form" role="tablist">
                                        <li class="nav-tab-item" role="presentation">   
                                            <a href="property-details-v4.html#forRent" class="nav-link-item active"  data-bs-toggle="tab">For Rent</a>
                                        </li>
                                        <li class="nav-tab-item" role="presentation">
                                            <a href="property-details-v4.html#forSale" class="nav-link-item" data-bs-toggle="tab">For Sale</a>
                                        </li>
                                    </ul>
                                                            ...
                                                            <div class="box">
                                                                ...
                                                                <div class="form-style">
                                                                    <div class="group-ip ip-icon">
                                                                        ...
                                                                        <a href="property-details-v4.html#" class="icon-right icon-location"></a>
                                                                    </div>
                                                                </div>
                                                                <div class="form-style">
                                    ...
                                    <ul>
                                        <li class="latest-property-item">
                                            <a href="property-details-v1.html" class="images-style">
                                                <img src="<?php bloginfo('template_url') ?>/images/home/house-8.jpg" alt="img">
                                            </a>
                                            <div class="content">
                                        ...
                                        <li class="latest-property-item">
                                            <a href="property-details-v1.html" class="images-style">
                                                <img src="<?php bloginfo('template_url') ?>/images/home/house-3.jpg" alt="img">
                                            </a>
                                            <div class="content">
                                                <div class="text-capitalize text-btn"><a href="property-details-v1.html" class="link">Casa Lomas de Machalí Machas</a></div>
                                                <ul class="meta-list mt-6">
                                        ...
                                        <li class="latest-property-item">
                                            <a href="property-details-v1.html" class="images-style">
                                                <img src="<?php bloginfo('template_url') ?>/images/home/house-28.jpg" alt="img">
                                            </a>
                                            <div class="content">
                                                <div class="text-capitalize text-btn"><a href="property-details-v1.html" class="link">Casa Lomas de Machalí Machas</a></div>
                                                <ul class="meta-list mt-6">
                                        ...
                                        <li class="latest-property-item">
                                            <a href="property-details-v1.html" class="images-style">
                                                <img src="<?php bloginfo('template_url') ?>/images/home/house-29.jpg" alt="img">
                                            </a>
                                            <div class="content">
                                                <div class="text-capitalize text-btn"><a href="property-details-v1.html" class="link">Casa Lomas de Machalí Machas</a></div>
                                                <ul class="meta-list mt-6">
                                        ...
                                        <li class="latest-property-item">
                                            <a href="property-details-v1.html" class="images-style">
                                                <img src="<?php bloginfo('template_url') ?>/images/home/house-19.jpg" alt="img">
                                            </a>
                                            <div class="content">
                                                <div class="text-capitalize text-btn"><a href="property-details-v1.html" class="link">Casa Lomas de Machalí Machas</a></div>
                                                <ul class="meta-list mt-6">
