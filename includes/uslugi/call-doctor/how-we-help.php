<section class="when-to-call py-5">
    <div class="container">
        <h2 class="section-title text-center mb-5">Когда к нам обращаться</h2>
...
<section class="how-we-help py-5">
    <div class="container">
        <h2 class="section-title text-center mb-5">Как мы помогаем</h2>
